 ...
 * generate RMI server proxy objects for instances of MatOperation.MatOperation.
 */
public interface MatOperationRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>absJ</code> M-function with 
     * 1 input argument.  
     *
     ...
     */
    public Object[] absJ(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>add</code> M-function with 2 
     * input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] add(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>angleJ</code> M-function 
     ...
     * in communication with the server.
     */
    public Object[] angleJ(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>conjugate</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] conjugate(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>diagonal</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] diagonal(int nargout, Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] divideByElement(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>eyeJ</code> M-function with 
     * 2 input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] eyeJ(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>getImag</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] getImag(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>getReal</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] getReal(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>invert</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] invert(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>maxJ</code> M-function with 
     * 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] maxJ(int nargout, Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] mergeColumn(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>mergeRow</code> M-function 
     ...
     * in communication with the server.
     */
    public Object[] mergeRow(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>multiply</code> M-function 
     * with 2 input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] multiply(int nargout, Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] multiplyByElement(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>multiplyI</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] multiplyI(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>normJ</code> M-function with 
     * 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] normJ(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>onesJ</code> M-function with 
     * 2 input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] onesJ(int nargout, Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] selectColumns(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>selectRows</code> M-function 
     * with 2 input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] selectRows(int nargout, Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] solveLinear(int nargout, Object... rhs) throws RemoteException;
    /**
     ...
     * in communication with the server.
     */
    public Object[] sparseMatrix(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>substract</code> M-function 
     * with 2 input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] substract(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>sumJ</code> M-function with 
     * 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] sumJ(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>toSparse</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] toSparse(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>transposeJ</code> M-function 
     * with 1 input argument.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] transposeJ(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>zerosJ</code> M-function 
     * with 2 input arguments.  
     *
     * Input arguments to standard interface methods may be passed as sub-classes of 
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of any 
     ...
     * in communication with the server.
     */
    public Object[] zerosJ(int nargout, Object... rhs) throws RemoteException;
